...
Scene::Scene()
{
	...
	showMenu = false;	// menu is on
	light0On = false;	// light 0 is off
	light1On = true;	// light 1 is off
...
void Scene::printMenu(void)
{
	...
	printGL(0.0f, 2.0f, -1.0f, "F1    - Tampilkan Menu	        ");
	printGL(0.0f, 2.3f, -1.0f, "F2    - Tambahkan Kepiting              ");
	printGL(0.0f, 2.6f, -1.0f, "F3    - Tambahkan Gurita          ");
	printGL(0.0f, 2.9f, -1.0f, "F4    - Tambahkan Bintang Laut          ");
	printGL(0.0f, 3.2f, -1.0f, "F5    - Tambahkan Ikan              ");
	printGL(0.0f, 3.5f, -1.0f, "F6    - Tambahkan Tanaman             ");

	glColor3f(0.5f, 1.0f, 0.0f);
	printGL(0.0f, 3.8f, -1.0f, "F/f   - Tampak Siang/Malam       ");
	//printGL(0.0f, 4.1f, -1.0f, "W/w   - Toggle wireframe on/off ");
	printGL(0.0f, 4.4f, -1.0f, "L/l   - Lampu On/Off  ");
	printGL(0.0f, 4.7f, -1.0f, "1/0   - Toggle light 1/0 on/off ");

	glColor3f(0.0f, 1.0f, 0.0f);
	printGL(0.0f, 5.0f, -1.0f, "A/Z   - Inc/Dec elevation angle  ");
