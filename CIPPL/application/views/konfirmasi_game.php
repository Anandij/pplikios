		...
		<div class="row" style="margin-top:30px;">
			...
			<div class="col-md-10">
				<div class="welcome">
					<div class="col-md-12">
						<center>
							<h2 style="margin-bottom:30px;">Konfirmasi Voucher Game</h2>
						</center>
					</div>
					<div class="col-md-12">
						...
						<div class="row">
							...
							<div class="panel panel-warning">
								<div class="panel-heading">
									<h3>Pembelian</h3>
									<p>Voucher Token Game <?php echo $nom; ?></p>
									<table>
										<tr>
											<td>ID Struk</td>
											<td>&nbsp;:&nbsp;&nbsp;</td>
									...
									Tekan tombol OK untuk cetak struk</p><a href="<?php echo base_url("Token/Selamat"); ?>">
