		...
		<div class="row" style="margin-top:30px;">
			...
			<div class="col-md-10">
				<div class="welcome">
					<div class="col-md-12">
						<center>
							<h2>Masukkan Nomer Handphone Anda</h2>
						</center>
					</div>
					<div class="col-md-12">
						<div class="col-md-1"></div>
						<div class="col-md-10">
							<form class="form-horizontal" action="<?php echo base_url("Pulsa/getNum"); ?>" method="post" role="form">
								<input type="text" class="form-control input-lg" placeholder="Nomor" name="Nomor" pattern="08+.{8,10}"   required title="MUST 10-12 PHONE-number">
								<center>
