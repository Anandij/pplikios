		...
		<div class="row" style="margin-top:30px;">
			...
			<div class="col-md-10">
				<div class="welcome">
					<div class="col-md-12">
						<center>
							<h2 style="margin-bottom:30px;">Konfirmasi Voucher</h2>
						</center>
					</div>
					<div class="col-md-12">
						<div class="col-md-1"></div>
						<div class="row">
							...
							<div class="panel panel-warning">
								<div class="panel-heading">
									<h3>Pembelian</h3>
									<p><?php echo $this->session->userdata('OP'); ?> Elektrik</p>
									<table>
										<tr>
											<td>ID struk</td>
											<td>&nbsp;:&nbsp;&nbsp;</td>
										...
										<tr>
											<td>Harga</td>
											<td>&nbsp;:&nbsp;&nbsp;</td>
											<td>Rp.<?php echo $temp; ?></td>
										</tr>
									</table>
									<p><br>Terima kasih anda telah memesan<br>
									pulsa elektronik pada I-KIOS Indomaret<br>
									Tekan tombol OK untuk cetak struk</p>
									<a href = "<?php echo base_url("Pulsa/Selamat"); ?>"
									<button class="btn btn-danger btn-lg" style="margin-top: 20px;">OK</button>
									</a>
